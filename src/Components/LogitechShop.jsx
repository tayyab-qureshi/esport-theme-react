  ...
  render() {
    return (
        ...
        <div className='flex mt-10 gap-5'>
            ...
            <div className='w-6/12'>
                <img src="/img/logitech_mice1.jpg" alt="" className='w-[100%] pt-20' />
            </div>
        </div>
